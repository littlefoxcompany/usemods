<template>
  <button
    ...
    class="flex h-11 translate-y-0 touch-manipulation select-none items-center justify-center gap-2.5 whitespace-nowrap rounded-full border px-5 text-lg font-medium transition-all"
    :class="colorClasses">
    <slot />
  </button>
</template>
