<template>
  <div class="mt-12 flex gap-4 text-balance" v-if="data?.prev || data?.next">
    <NuxtLink
      prefetch
      v-if="data?.prev"
      :to="data?.prev._path"
      ...
      <div class="text-lg">{{ data?.prev.title }}</div>
      <div v-if="data?.prev.lead" class="text-sm dark:text-white/50">{{ data?.prev.lead }}</div>
    </NuxtLink>
    <NuxtLink
      prefetch
      v-if="data?.next"
      ...
      <div class="text-lg">{{ data?.next.title }}</div>
      <div v-if="data?.next.lead" class="text-sm dark:text-white/50">{{ data?.next.lead }}</div>
    </NuxtLink>
  </div>
</template>
