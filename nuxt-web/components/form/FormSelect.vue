<template>
  <div class="relative w-full">
    ...
    <div class="group relative cursor-pointer">
      ...
      <Icon name="heroicons:chevron-down" class="pointer-events-none absolute right-3 top-3.5 h-4 w-4 text-gray-500 transition-all group-hover:rotate-180 peer-open:rotate-180" />
    </div>
  </div>
</template>
