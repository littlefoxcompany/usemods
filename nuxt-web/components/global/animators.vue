  ...
  <svg
    ...
    <g :fill="fill">
      <g class="nc-loop-heart-24-icon-f">
        <path
          d="M19.562,6.446a4.9,4.9,0,0,0-6.941,0,4.965,4.965,0,0,0-.619.76,4.913,4.913,0,1,0-7.561,6.2L12,21l7.56-7.588a4.939,4.939,0,0,0,0-6.966Z"
          :fill="fill" />
        <circle
          cx="12"
          cy="12"
...
.nc-loop-heart-24-icon-f :nth-child(1) {
  animation: nc-loop-heart-anim var(--animation-duration) infinite
}

.nc-loop-heart-24-icon-f :nth-child(2) {
  transform: scale(0);
